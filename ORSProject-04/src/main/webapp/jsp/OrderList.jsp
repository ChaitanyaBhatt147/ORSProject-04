...
<%@page import="in.co.rays.proj4.controller.OrderListCtl"%>
...
<body>
	...
	<div align="center">
		<h1 align="center" style="margin-bottom: -15; color: navy;">Order
			List</h1>
		...
		<form action="<%=ORSView.ORDER_LIST_CTL%>" method="post">
			...
			<%
				...
				List<OrderBean> list = (List<OrderBean>) ServletUtility.getList(request);
			...
			<table style="width: 100%">
				<tr>
					<td align="center">
						...
						value="<%=ServletUtility.getParameter("orderId", request)%>">&emsp;
			...
			<table style="width: 100%">
				<tr>
					...
					<td align="center" style="width: 25%">
						<input type="submit" name="operation"
						value="<%=OrderListCtl.OP_NEW%>">
					</td>

					<td align="center" style="width: 25%">
						<input type="submit" name="operation"
						value="<%=OrderListCtl.OP_DELETE%>">
					</td>
