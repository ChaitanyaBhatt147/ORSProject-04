	...
	<form action="<%=ORSView.USER_REGISTRATION_CTL%>" method="post">
		...
		<div align="center">
			...
			<table>
				...
				<tr>
					<th>Last Name:</th>
					<td><input type="text" name="lastName" value="<%=DataUtility.getStringData(bean.getLastName())%>"></td>
				...
				<tr>
					<th>Confirm:</th>
					<td><input type="text" name="confirmPassword" value="<%=DataUtility.getStringData(bean.getConfirmPassword())%>"></td>
					<td style="position: fixed;"><font color="red"> <%=ServletUtility.getErrorMessage("confirmPassword", request)%></font></td>
				</tr>
				<tr>
					<th>DOB:</th>
					<td><input type="date" name="dob" style="width: 98%" value="<%=DataUtility.getDateString(bean.getDob())%>"></td>
