...
@WebServlet(name = "RoomListCtl", urlPatterns = { "/ctl/RoomListCtl" })
public class RoomListCtl extends BaseCtl {

    private static final Logger log = Logger.getLogger(RoomListCtl.class);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<RoomBean> list = model.search(bean, pageNo, pageSize);
            List<RoomBean> next = model.search(bean, pageNo + 1, pageSize);
        ...
        try {
            ...
            if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
                ...
                if (ids != null && ids.length > 0) {
                    ...
                    ServletUtility.setSuccessMessage("Room deleted successfully", request);
