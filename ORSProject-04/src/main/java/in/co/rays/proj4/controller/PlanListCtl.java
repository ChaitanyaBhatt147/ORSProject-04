...
/**
 * PlanListCtl handles listing, searching, pagination and delete operations
 * for Plan.
 * 
 * author Chaitanya Bhatt
 */

@WebServlet(name = "PlanListCtl", urlPatterns = { "/ctl/PlanListCtl" })
public class PlanListCtl extends BaseCtl {

	private static final Logger log = Logger.getLogger(PlanListCtl.class);
		...
		try {
			...
			if (OP_SEARCH.equalsIgnoreCase(op) || OP_NEXT.equalsIgnoreCase(op)
				...
				if (ids != null && ids.length > 0) {
					...
					PlanBean deleteBean = new PlanBean();
